...
**Snapshot date:** 2026-05-09 (Phase 4 Step 2C — frontend dashboard live)
...
- Phase 4 Step 3: Quota enforcement against rate-limit + per-tool caps + (eventually) Google OAuth.
